...
SELECT OfferID,
 ...
 WHERE ( StatusID = 100 or StatusID = 60) and CRMID is not NULL and OfferID IN (84100) AND (BO.AgencyID<>'150aec84-7a0f-49b1-97e0-ff805e5a2201' OR BO.AgencyID IS NULL) 
